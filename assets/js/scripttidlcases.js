...
if (window.innerWidth >= 1024) {
  window.location = "tidlcasesstor.html";
}
...
//Funktion til vis flere videoer



function showVideos() {
  let moreText = document.getElementById("more");
  let btnText = document.getElementById("moreVideos");

  if (moreText.style.display === "block") {
    moreText.style.display = "none";
    btnText.innerHTML = `<p>TRYK FOR FLERE CASES<i class="fas fa-angle-down"></i></p>`;

  } else {
    moreText.style.display = "block";
    btnText.innerHTML = `<p>TRYK FOR FÆRRE CASES<i class="fas fa-angle-up"></i></p>`;
